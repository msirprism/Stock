...
if(isset($_POST['submit'])){
    ...
    $type =$_POST['type'];
    $ref =$_POST['ref'];
    if(empty($name) ||empty($phone)|| empty($address)|| empty($machine)|| empty($type)||empty($ref)){
        ...
        if($i==0){
            $query ="insert into clients(date,time,name,phone,address,machine,type,ref) values('$date','$time','$name','$phone','$address','$machine','$type','$ref')";
